...
#Solution taken from Kelvin: https://github.com/rohitash-chandra/python-bootcamp/tree/main/exercise1/part1/solution
...
def calc_class(BMI, age):
    ...
    if age > 18:
        ...
        print(adult_groups[group], 'is your group')
    else:
        group = sum(BMI > child_classes)
        print(child_groups[group], 'is your group')
